#!/usr/bin/env python3
"""Minimal YOLOv8s training script for the UAV-benchmark-M dataset.
...
def main() -> None:
    """Train YOLOv8s model with optimized settings."""
    ...
    model.train(
        ...
        batch=-1,  # Auto-batch: automatically determine optimal batch size (~60% GPU memory)
        imgsz=640,  # Default image size for YOLOv8s
        rect=True,  # Rectangular training for faster processing
        ...
        # Learning rate settings (auto-optimized for SGD)
